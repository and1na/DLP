...
public class PmmParser extends Parser {
	...
	public static final int
		...
		T__38=39, T__39=40, T__40=41, INT_CONSTANT=42, REAL_CONSTANT=43, CHAR_CONSTANT=44, 
		ID=45, ONE_LINE_COMMENT=46, MULTI_LINE_COMMENT=47, SPACE=48, TRASH=49;
	public static final int
		RULE_program = 0, RULE_main = 1, RULE_expression = 2, RULE_statement = 3, 
		RULE_caseList = 4, RULE_case = 5, RULE_defaultcase = 6, RULE_body = 7, 
		RULE_expressionList = 8, RULE_functioninvocation = 9, RULE_funcDefinition = 10, 
		RULE_parametersList = 11, RULE_type = 12, RULE_structFields = 13, RULE_ids = 14, 
		RULE_basicType = 15, RULE_varDefinition = 16, RULE_parameter = 17;
	private static String[] makeRuleNames() {
		return new String[] {
			"program", "main", "expression", "statement", "caseList", "case", "defaultcase", 
			"body", "expressionList", "functioninvocation", "funcDefinition", "parametersList", 
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'.'", "'-'", "'!'", "'*'", "'/'", "'%'", "'+'", "'>'", "'>='", "'<'", 
			"'<='", "'!='", "'=='", "'&&'", "'||'", "'return'", "';'", "'print'", 
			"'input'", "'='", "'while'", "'if'", "'else'", "'++'", "'switch'", "'case'", 
			"'default'", "','", "'struct'", "'int'", "'double'", "'char'", null, 
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"CHAR_CONSTANT", "ID", "ONE_LINE_COMMENT", "MULTI_LINE_COMMENT", "SPACE", 
			"TRASH"
		};
	}
	...
	public final MainContext main() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 65991534974984L) != 0)) {
				{
				{
				setState(65);
	...
	public static class StatementContext extends ParserRuleContext {
		...
		public Token operator;
		public ExpressionContext exp;
		public CaseListContext cases;
		public DefaultcaseContext caseDefault;
		public List<ExpressionContext> expression() {
			return getRuleContexts(ExpressionContext.class);
		}
		public ExpressionContext expression(int i) {
	...
	public final StatementContext statement() throws RecognitionException {
		...
		try {
			...
			case 9:
				...
				{
				setState(193);
				((StatementContext)_localctx).kw = match(T__33);
				setState(194);
				match(T__2);
				setState(195);
				...
				match(T__5);
				setState(199);
				((StatementContext)_localctx).cases = caseList();
				setState(200);
				((StatementContext)_localctx).caseDefault = defaultcase();
				setState(201);
				match(T__6);
				_localctx.ast.add(new Switch(((StatementContext)_localctx).kw.getLine(),((StatementContext)_localctx).kw.getCharPositionInLine()+1,((StatementContext)_localctx).exp.ast,((StatementContext)_localctx).cases.ast,((StatementContext)_localctx).caseDefault.ast));
				}
				break;
			}
		}
	...
	public static class CaseListContext extends ParserRuleContext {
		public List<Case> ast = new ArrayList<Case>();
		public CaseContext c;
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof PmmListener ) ((PmmListener)listener).enterCaseList(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof PmmListener ) ((PmmListener)listener).exitCaseList(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof PmmVisitor ) return ((PmmVisitor<? extends T>)visitor).visitCaseList(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public final CaseListContext caseList() throws RecognitionException {
		...
		try {
			...
			do {
				...
				{
				setState(206);
				((CaseListContext)_localctx).c = case_();
				_localctx.ast.add(((CaseListContext)_localctx).c.ast);
				}
				}
				setState(211); 
				_errHandler.sync(this);
	...
	public static class CaseContext extends ParserRuleContext {
		public Case ast;
		public List<Statement> caseBody = new ArrayList<Statement>();
		public Token kw;
		public ExpressionContext cond;
		public BodyContext bd;
		public ExpressionContext expression() {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof PmmListener ) ((PmmListener)listener).enterCase(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof PmmListener ) ((PmmListener)listener).exitCase(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof PmmVisitor ) return ((PmmVisitor<? extends T>)visitor).visitCase(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public final CaseContext case_() throws RecognitionException {
		...
		try {
			...
			{
			setState(213);
			((CaseContext)_localctx).kw = match(T__34);
			setState(214);
			((CaseContext)_localctx).cond = expression(0);
			setState(215);
			match(T__4);
			setState(216);
			((CaseContext)_localctx).bd = body();

			                _localctx.caseBody.addAll(((CaseContext)_localctx).bd.ast);
			                ((CaseContext)_localctx).ast =  new Case(((CaseContext)_localctx).kw.getLine(),((CaseContext)_localctx).kw.getCharPositionInLine()+1, ((CaseContext)_localctx).cond.ast,_localctx.caseBody);
	...
	public static class DefaultcaseContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof PmmListener ) ((PmmListener)listener).enterDefaultcase(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof PmmListener ) ((PmmListener)listener).exitDefaultcase(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof PmmVisitor ) return ((PmmVisitor<? extends T>)visitor).visitDefaultcase(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public final DefaultcaseContext defaultcase() throws RecognitionException {
		...
		try {
			...
			{
			setState(219);
			((DefaultcaseContext)_localctx).kw = match(T__35);
			setState(220);
			match(T__4);
			setState(221);
			((DefaultcaseContext)_localctx).bd = body();

			                _localctx.caseBody.addAll(((DefaultcaseContext)_localctx).bd.ast);
			                ((DefaultcaseContext)_localctx).ast =  new Case(((DefaultcaseContext)_localctx).kw.getLine(),((DefaultcaseContext)_localctx).kw.getCharPositionInLine()+1, new IntLiteral(0,0,0),_localctx.caseBody);
	...
	public final ExpressionListContext expressionList() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 65970697672712L) != 0)) {
				{
				setState(239);
	...
	public final TypeContext type() throws RecognitionException {
		...
		try {
			...
			case T__37:
				...
				{
				setState(311);
				((TypeContext)_localctx).st = match(T__37);
				setState(312);
				match(T__5);
				setState(313);
	...
	public final BasicTypeContext basicType() throws RecognitionException {
		...
		try {
			...
			case T__38:
				...
				{
				setState(340);
				((BasicTypeContext)_localctx).int_ = match(T__38);
			...
			case T__39:
				...
				{
				setState(342);
				((BasicTypeContext)_localctx).double_ = match(T__39);
			...
			case T__40:
				...
				{
				setState(344);
				((BasicTypeContext)_localctx).char_ = match(T__40);
	...
	public final VarDefinitionContext varDefinition() throws RecognitionException {
		...
		enterRule(_localctx, 32, RULE_varDefinition);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(349);
